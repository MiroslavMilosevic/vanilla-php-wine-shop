...
<head>
    ...
    <!-- Favicon -->
    <link href="app/public/img/favicon.ico" rel="icon">
            ...
            <div class="col-lg-5 mb-30">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="app/public/img/product-3.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="app/public/img/product-4.jpg" alt="Image">
                        </div> -->
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <img src="app/public/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
